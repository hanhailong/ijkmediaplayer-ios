...
CFLAGS=  -arch i386 -mios-simulator-version-min=5.1.1 -std=c99 -mdynamic-no-pic -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch i386 -mios-simulator-version-min=5.1.1 -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch i386 -mios-simulator-version-min=5.1.1 -mdynamic-no-pic -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch i386 -mios-simulator-version-min=5.1.1  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
