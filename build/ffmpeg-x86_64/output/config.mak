...
CFLAGS=  -arch x86_64 -mios-simulator-version-min=7.0 -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch x86_64 -mios-simulator-version-min=7.0 -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=7.0 -mdynamic-no-pic -fPIC -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
