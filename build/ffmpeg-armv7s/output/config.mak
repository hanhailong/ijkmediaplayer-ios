...
CC_IDENT=Apple LLVM version 6.1.0 (clang-602.0.49) (based on LLVM 3.6.0svn)
ARCH=arm
INTRINSICS=neon
...
CFLAGS=  -arch armv7s -miphoneos-version-min=5.1.1 -mcpu=swift -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch armv7s -miphoneos-version-min=5.1.1 -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7s -miphoneos-version-min=5.1.1 -mcpu=swift -fPIC -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7s -miphoneos-version-min=5.1.1  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
